...
- **DB 테스트 랩**(별도 페이지, 실 DB 연동): <http://localhost:8081/demo/db.html> — CRUD · CRUD 오류(중복 409/미존재 404/빈값 400/트랜잭션 롤백) · 멀티커넥션 읽기/쓰기 분리 · XA 성공/실패를 실제 DB 로 직접 테스트(엔드포인트 `/demo/db/lab/*`).
